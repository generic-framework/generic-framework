        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusPosition = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<int>(type: "int", nullable: false),
                    UpdatedBy = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskStatuId = table.Column<int>(type: "int", nullable: true),
                    DeparmentId = table.Column<int>(type: "int", nullable: true),
                    MainTaskId = table.Column<int>(type: "int", nullable: true),
                    DevelopmentCompletionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ProcessingDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PriortyTypesId = table.Column<int>(type: "int", nullable: true),
                    SubjectTypesId = table.Column<int>(type: "int", nullable: true),
                    SubjectTypes = table.Column<int>(type: "int", nullable: true),
                    PriorityTypes = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<int>(type: "int", nullable: false),
                    UpdatedBy = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskEntities_TaskEntities_MainTaskId",
                        column: x => x.MainTaskId,
                        principalTable: "TaskEntities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaskEntities_TaskStatus_TaskStatuId",
                        column: x => x.TaskStatuId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskFiles_TaskEntities_TaskId",
                        column: x => x.TaskId,
                        principalTable: "TaskEntities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskUsers_TaskEntities_TaskId",
                        column: x => x.TaskId,
                        principalTable: "TaskEntities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskEntities_MainTaskId",
                table: "TaskEntities",
                column: "MainTaskId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskEntities_TaskStatuId",
                table: "TaskEntities",
                column: "TaskStatuId");
